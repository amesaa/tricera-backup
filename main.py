...
class Tricerabot(commands.Bot):
    def __init__(self, email : str, password : str, **kwargs) -> None:
        self.status = '🔥discord.gg/JZdWzxXxbW🔥'
        ...
        self.default_backpack = "BID_004_BlackKnight"
        self.default_pickaxe = "Pickaxe_Lockjaw"
        self.banner = "INFLUENCERBANNER57"
        self.banner_colour = "defaultcolor15"
        self.default_level = 1
        self.default_bp_tier = 1
        self.default_emote = "EID_AshtonSaltLake"

        self.sanic_app = sanic_app
        self.server = server
        self.welcome_message = "Hey {DISPLAY_NAME} Join Our Discord Server: discord.gg/JZdWzxXxbW"
        self.whisper_message = "Hey {DISPLAY_NAME} Join Our Discord Server: discord.gg/JZdWzxXxbW"
